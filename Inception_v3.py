...
#%%    
model.fc = nn.Sequential(nn.AvgPool2d(),
                        nn.Linear(2048, 512),
                        nn.ReLU(),
                        nn.Dropout(0.2),
                        nn.Linear(512, 100),
...
plt.show()
plt.savefig('./drive/MyDrive/models/Inception_v3_part1_20_epochs_Loss_Graph.png')

torch.save(model.state_dict(), './drive/MyDrive/models/Inception_v3_part1_20_epochs.pt')
